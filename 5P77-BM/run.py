...
# -*- coding: utf-8 -*-
"""
Created on Tue Apr 23 12:29:56 2024
...
from rbm import RBM
from Gauss_RBM import Gauss_RBM
...
# create a Gausian Restricted Boltzmann Machine
#model = Gauss_RBM(n_vis=n_vis, n_hid=n_hid, k=1)
...
'''
train_loader = torch.utils.data.DataLoader(
    datasets.FashionMNIST('./output/', train=True, download=True,
                   transform=transforms.Compose([
                       transforms.ToTensor()
                   ])),
    batch_size=batch_size
